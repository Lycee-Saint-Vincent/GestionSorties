 ...
 */
final class Version20230615093311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, projet_activite_id INT DEFAULT NULL, nom_activite VARCHAR(255) NOT NULL, cout_activte DOUBLE PRECISION NOT NULL, commentaire_activite VARCHAR(255) NOT NULL, adage_activite DOUBLE PRECISION NOT NULL, INDEX IDX_B87555154035DC8F (projet_activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contenir (id INT AUTO_INCREMENT NOT NULL, commentaire VARCHAR(255) NOT NULL, prise_charge_culture DOUBLE PRECISION NOT NULL, prise_charge_lycee DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE activite ADD CONSTRAINT FK_B87555154035DC8F FOREIGN KEY (projet_activite_id) REFERENCES projet (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite DROP FOREIGN KEY FK_B87555154035DC8F');
